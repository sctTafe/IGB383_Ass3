...
public class MechAIWeapons : MonoBehaviour {
	...
	void Update () {
        ...
        LaserBeam();    //Due to nature of LaserBeam weapon, needs to check constantly
    }

    public void Lasers() {

        if (mechSystem.energy >= 4) { 
    ...
    public void Cannons() {
        ...
        if (Time.time > CannonFireTime && mechSystem.shells >= 2) {
    ...
    public void LaserBeam() {
        ...
        if (Time.time > beamTimer && mechSystem.energy >= 250 && laserBeamAI) {
            beamsActive = true;
    ...
    public void MissileArray() {
        ...
        //Firing System
        if (Time.time > missileFireTime && mechSystem.missiles >= 18) {
